# Razorpay Payment Spec

## Purpose
This capability defines the Razorpay integration flow, including payment method selection in checkout, dynamic loading of the checkout SDK, edge function endpoints for order creation/signature verification, and writing the final paid order to the database.
